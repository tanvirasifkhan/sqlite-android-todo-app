...
public class PendingTodoModel {
    ...
    public PendingTodoModel(int todoID, String todoTitle, String todoContent, String todoDate, String todoTimeFrom, String toTimeTo, String todoPriority, String todoTag, String todoColor) {
        this.todoID = todoID;
